            ...
            <div className="w-full">
                <div className='w-full'>
                    ...
                    <div className="w-10/12 flex flex-col mx-auto mt-10">
                        <article className="text-lg text-justify">
                            ...
                            think, it is not suitable with me because I like critical thinking, problem solving,
                            innovation,
                            more and more. So, I choose this career which is a developer. In 2020, I started learning
                            about
                ...
                <div className="w-full mt-20">
                    ...
                    {educations.map(education => (
                        <div key={education.school} className="w-10/12 mx-auto mt-10">
                            <h1 className="text-xl font-bold">{education.school}</h1>

                            {education.courses.map(course => (
                                <ul key={course} className="my-5 list-disc ml-10">
                                    <li>{course}</li>
                                </ul>
                            ))}
                        </div>
